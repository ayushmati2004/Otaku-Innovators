...
function LandinfPage() {
    motion
    return (
        <div data-scroll-section="" data-scroll-speed="-0.8" className='w-full h-screen bg-grey-100 pt-1'>
            <div className='textstructure mt-60 px-20'>
                {["WE DELIVER", "INSIGHTFUL", "PUBLICATIONS"].map((item, index) => {
                    return <div className="masker">
                        <div className="w-fit flex items-end overflow-hidden">
                            {index === 1 && (
                                <motion.div initial={{ width: 0 }} animate={{ width: "9vw" }} transition={{ ease: [0.76, 0, 0.24, 1] }} className="mr-[1vw] w-[9vw] rounded-tl rounded-tr rounded-bl rounded-br h-[7.5vw] top-[1vw] relative bg-[#254E58]"></motion.div>
                            )}
